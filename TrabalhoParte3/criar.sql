...
CREATE TABLE CANTINA(   
	...
	idPavilhao INTEGER REFERENCES PAVILHAO(idPavilhao) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE DOCENTE(
    ...
    idDepartamento INTEGER REFERENCES DEPARTAMENTO(idDepartamento) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE NAO_DOCENTE(
    ...
    idStaff INTEGER UNIQUE REFERENCES STAFF(idStaff) ON DELETE CASCADE ON UPDATE CASCADE
);

DROP TABLE IF EXISTS SEGURANCA;
CREATE TABLE SEGURANCA(
	idSeguranca INTEGER PRIMARY KEY,
	idNaoDocente INTEGER UNIQUE REFERENCES NAO_DOCENTE(idNaoDocente) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE UNIDADE_CURRICULAR(
    ...
    regente INTEGER REFERENCES DOCENTE(idDocente) ON DELETE CASCADE ON UPDATE CASCADE,
    nome TEXT NOT NULL,
...
CREATE TABLE TESTE(
    ...
    idAvaliacao INTEGER UNIQUE REFERENCES AVALIACAO(idAvaliacao) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE BLOCO_HORARIO(
    ...
    idTurma INTEGER REFERENCES TURMA(idTurma) ON DELETE CASCADE ON UPDATE CASCADE,
    idSala INTEGER REFERENCES SALA(idSala) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE TURMA(
	...
	idCadeira INTEGER REFERENCES UNIDADE_CURRICULAR(idCadeira) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE CURSO(
    ...
    diretor INTEGER REFERENCES DOCENTE(idDocente) ON DELETE CASCADE ON UPDATE CASCADE,
    nome TEXT NOT NULL,
...
CREATE TABLE ANDAR(
    ...
    idPavilhao INTEGER REFERENCES PAVILHAO(idPavilhao) ON DELETE CASCADE ON UPDATE CASCADE,
    numero INTEGER
);
...
CREATE TABLE SALA(
	...
	idAndar INTEGER REFERENCES ANDAR(idAndar) ON DELETE CASCADE ON UPDATE CASCADE,
	numero INTEGER CONSTRAINT VALID_NUMERO check(numero > 0),
...
CREATE TABLE DEPARTAMENTO(
    ...
    chefeDoDepartamento INTEGER REFERENCES DOCENTE(idDocente) ON DELETE CASCADE ON UPDATE CASCADE,
    nome TEXT NOT NULL,
...
CREATE TABLE CONTRATO_FORNECE_COMIDA(
	idFornecedor INTEGER REFERENCES FORNECEDOR_DE_COMIDA(idFornecedor) ON DELETE CASCADE ON UPDATE CASCADE,
    idCantina INTEGER REFERENCES CANTINA(idCantina) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE COZINHA_EM(
	idCozinheiro INTEGER REFERENCES COZINHEIRO(idCozinheiro) ON DELETE CASCADE ON UPDATE CASCADE,
    idCantina INTEGER REFERENCES CANTINA(idCantina) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE INSTANCIA_DE_AVALIACAO(
	idEstudante INTEGER REFERENCES ESTUDANTE(idEstudante) ON DELETE CASCADE ON UPDATE CASCADE,
    idCadeira INTEGER REFERENCES UNIDADE_CURRICULAR(idCadeira) ON DELETE CASCADE ON UPDATE CASCADE,
    idAvaliacao INTEGER UNIQUE REFERENCES AVALIACAO(idAvaliacao) ON DELETE CASCADE ON UPDATE CASCADE,
    PRIMARY KEY (idEstudante,idCadeira,idAvaliacao)
);

DROP TABLE IF EXISTS INSCRITO_EM_CURSO;
CREATE TABLE INSCRITO_EM_CURSO(
	idEstudante INTEGER REFERENCES ESTUDANTE(idEstudante) ON DELETE CASCADE ON UPDATE CASCADE,
    idCurso INTEGER REFERENCES  CURSO(idCurso) ON DELETE CASCADE ON UPDATE CASCADE,
    PRIMARY KEY(idEstudante,idCurso)
);

DROP TABLE IF EXISTS INSCRITO_EM_TURMA;
CREATE TABLE INSCRITO_EM_TURMA(
	idEstudante INTEGER REFERENCES ESTUDANTE(idEstudante) ON DELETE CASCADE ON UPDATE CASCADE,
    idTurma INTEGER REFERENCES TURMA(idTurma) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE LECIONA(
	idDocente INTEGER REFERENCES DOCENTE(idDocente) ON DELETE CASCADE ON UPDATE CASCADE,
    idCadeira INTEGER REFERENCES UNIDADE_CURRICULAR(idCadeira) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE LIMPA(
	idContinuo INTEGER REFERENCES CONTINUO(idContinuo) ON DELETE CASCADE ON UPDATE CASCADE,
    idSala INTEGER REFERENCES SALA(idSala) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE GUARDA(
	idSeguranca INTEGER REFERENCES SEGURANCA(idSeguranca) ON DELETE CASCADE ON UPDATE CASCADE,
    idPavilhao INTEGER REFERENCES PAVILHAO(idPavilhao) ON DELETE CASCADE ON UPDATE CASCADE,
